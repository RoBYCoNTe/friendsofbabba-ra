...
const DraggableDatagridBody = React.forwardRef(
	(
		{
			children,
			className,
		...
		const onDragEnd = async (result) => {
			...
			list[itemIndex][draggableField] = newPosition;

			// Sort the list by the order_index
			list.sort((a, b) => a[draggableField] - b[draggableField]);
...
export const PureDatagridBody = memo((props) => (
	<DraggableDatagridBody row={<PureDatagridRow />} {...props} />
));
